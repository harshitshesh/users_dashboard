...
const Userstable = ({users, loading, onEdit, onDelete}) => {
  ...
  if (loading) {
    return (
      <div className="flex flex-col justify-center items-center py-32 bg-slate-900 rounded-t-xl w-full h-full">
  ...
  if (users.length === 0) {
    return (
      <div className="flex flex-col justify-center items-center py-32 bg-slate-900 rounded-t-xl text-center px-4 w-full h-full">
  ...
  return (
    <table className="min-w-full text-sm text-left">
      <thead className="bg-slate-800/80 text-slate-400 uppercase text-xs tracking-wider border-b border-slate-700 sticky top-0 z-10 backdrop-blur-md">
        <tr>
